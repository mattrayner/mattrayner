...
def create_case_study(title:, intro:, body:, attachments: 0)
  puts "\t\t- #{title}"
...
create_case_study(title: 'Megafone', intro: 'A full e-commerce solution for a small remote mobile repair service.', body: 'A bit of body', attachments: 6)